// @editorjs/paragraph@2.11.6 downloaded from https://ga.jspm.io/npm:@editorjs/paragraph@2.11.6/dist/paragraph.mjs

(function(){try{if(typeof document<"u"){var e=document.createElement("style");e.appendChild(document.createTextNode(".ce-paragraph{line-height:1.6em;outline:none}.ce-block:only-of-type .ce-paragraph[data-placeholder-active]:empty:before,.ce-block:only-of-type .ce-paragraph[data-placeholder-active][data-empty=true]:before{content:attr(data-placeholder-active)}.ce-paragraph p:first-of-type{margin-top:0}.ce-paragraph p:last-of-type{margin-bottom:0}")),document.head.appendChild(e)}}catch(e){console.error("vite-plugin-css-injected-by-js",e)}})();const e='<svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24"><path stroke="currentColor" stroke-linecap="round" stroke-width="2" d="M8 9V7.2C8 7.08954 8.08954 7 8.2 7L12 7M16 9V7.2C16 7.08954 15.9105 7 15.8 7L12 7M12 7L12 17M12 17H10M12 17H14"/></svg>';function l(e){const t=document.createElement("div");t.innerHTML=e.trim();const a=document.createDocumentFragment();return a.append(...Array.from(t.childNodes)),a
/**
...
/**
   ...
   * @public
   */}merge(e){if(!this._element)return;this._data.text+=e.text;const t=l(e.text);this._element.appendChild(t),this._element.normalize()
/**
